...
long sysconf(int name)
{
	static const int values[] = { // XXX EMSCRIPTEN int instead of short
		...
		[_SC_DELAYTIMER_MAX] = 2147483647, // XXX EMSCRIPTEN replace JT_DELAYTIMER_MAX
		[_SC_MQ_OPEN_MAX] = -1,
		...
		[_SC_XBS5_LP64_OFF64] = -1, // XXX EMSCRIPTEN replace sizeof(long)==8 ? 1 : -1,
		...
		[_SC_V6_LP64_OFF64] = -1, // XXX EMSCRIPTEN replace sizeof(long)==8 ? 1 : -1,
